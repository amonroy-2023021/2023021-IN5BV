...
Delimiter $$
	create procedure sp_AgregarDetalleFactura(in precioUnitario decimal(10,2), in cantidad int, in factura_numeroFactura int, in productos_codigoProducto varchar(15))
		Begin
